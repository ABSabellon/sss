				...
				<fieldset>
					...
					<div class='row'>
						<?php
							...
							echo form_label('Additional Details Form NW-1', 'sss_number', $additional_details_label);
						?>
					</div>
					...
					<div class="form-group">
						<?php
							...
							echo "<div class='col-md-6'>" . form_input($sss_working_spouse) . "</div>";
						?>
					</div>

					<div class="form-group">
						<?php
							$non_working_salary_credit = array(
								'name' => 'non_working_salary_credit',
								'id' => 'non_working_salary_credit',
								'placeholder' => 'Non Working Spouse Salary Credit',
								'class' => 'form-control input-md',
								'required' => 'required'
							);
							...
							echo "<div class='col-md-8'>" . form_input($non_working_salary_credit) . "</div>";
							echo "<div class='col-md-4'>" . form_input($date_approved) . "</div>";
						?>
						<script type="text/javascript">
